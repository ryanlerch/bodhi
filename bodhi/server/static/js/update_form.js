...
$(document).ready(function() {
    ...
    function loadBugs(packagename) {
        ...
        return function(callback){
            $.ajax({
                url: 'https://bugzilla.redhat.com/rest/bug?bug_status=__open__&component='+packagename+products_string+'&include_fields=summary,status,id,product,component,version',
                type: 'GET',
                dataType: 'jsonp',
                error: function() {
                    callback();
